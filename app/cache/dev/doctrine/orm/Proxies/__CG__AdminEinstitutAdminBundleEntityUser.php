 ...
 */
class User extends \Admin\EinstitutAdminBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'avatar', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'ville', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'pays', '' . "\0" . 'Admin\\EinstitutAdminBundle\\Entity\\User' . "\0" . 'etablissements', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addEtablissement(\Admin\EinstitutAdminBundle\Entity\Etablissement $etablissements)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEtablissement', array($etablissements));

        return parent::addEtablissement($etablissements);
    }
    ...
    public function removeEtablissement(\Admin\EinstitutAdminBundle\Entity\Etablissement $etablissements)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEtablissement', array($etablissements));

        return parent::removeEtablissement($etablissements);
    }
    ...
    public function getEtablissements()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEtablissements', array());
